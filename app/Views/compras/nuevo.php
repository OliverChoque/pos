            ...
            <form method="POST" id="form_compra" name="form_compra" action="<?php echo base_url(); ?>/compras/guarda" autocomplete="off" >
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-4">
                            <label><br><br></label>
                            <button id="agregar_producto" name="agregar_producto" type="button" onclick="agregarProducto(id_producto.value, cantidad.value, '<?php echo $id_compra;?>')" class="btn btn-warning"><i class="fa-solid fa-plus"></i> Agregar Producto</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 offset-md-6">
                        ...
                        <button type="button" id="completa_compra" class="btn btn-success"><i class="fa-regular fa-clipboard-list-check"></i> Completar compra</button>
                    </div>
                </div>
            </form>
        </div>
