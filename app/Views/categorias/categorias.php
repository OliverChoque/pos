<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <div>
                <p>
                    <a href="<?php echo base_url(); ?>/categorias/nuevo" class="btn btn-success"><i class="fa-solid fa-plus"></i> Agregar</a>
                    <a href="<?php echo base_url(); ?>/categorias/eliminados" class="btn btn-info"><i class="fa-solid fa-xmark"></i> Eliminados</a>
                </p>
            </div>
