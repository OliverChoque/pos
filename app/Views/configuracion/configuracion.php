<div id="layoutSidenav_content" style="background: rgb(255, 255, 255)">
    <main>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6"> 
                        <img src="<?php echo base_url(); ?>/images/logo.png" class="img-responsive img-fluid rounded mx-auto d-block">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <p class="text-success">Cargar imagen png</p>
                    </div>       
                    <div class="col-12 col-sm-6">
                        <br>
