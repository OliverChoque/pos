...
<html lang="es">
    ...
    <body class="sb-nav-fixed"  style="background: #f8f9fc">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?php echo base_url() ?>/dashboard">Sistema de Venta</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto  me-3 me-lg-4 ">
                <li class="nav-item dropdown">
                    ...
                    &nbsp <img src="<?php echo base_url() . '/images/perfil.jfif';?>" alt="mdo" width="32" height="32" class="rounded-circle">
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="#">Perfil</a></li>
                        <li><a class="dropdown-item" href="<?php echo base_url(); ?>/usuarios/cambia_password">Privacidad</a></li>
                        <li><a class="dropdown-item" href="/proyecto/public/configuracion">Configuración</a></li>
